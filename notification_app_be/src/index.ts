...
const getNotificationType = (value: unknown) => Array.isArray(value) ? String(value[0] || '') : String(value || '');

const applyNotificationQuery = (notifications: Notification[], query: express.Request['query']) => {
